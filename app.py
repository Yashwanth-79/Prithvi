...
def login_signup():
    ...
    st.session_state.email = st.text_input("Enter your email ✉️", placeholder="you@example.com", key="login_email")
    st.session_state.password = st.text_input("Enter your password 🔑", type="password", placeholder="Your Password", key="login_password")
...
def water_management():
    ...
    with st.sidebar:
        st.markdown("""
        1. 🏞️ Select your region or location
        2. 📅 View historical water levels and trends
        3. 📊 Get suggestions on optimal water management practices
        """)
...
def crop_market_analysis():
    ...
    def main():
        ...
        with st.sidebar:
            ...
            2. 📊 View market trends and price fluctuations
            3. 🔍 Get insights on optimal selling times and regions
            """)
...
def main_app():
    ...
    if app_mode == "Home":
        ...
        🌊 **Water Management:**
        - 🔮 **Predict Future Water Levels**: Get AI-powered forecasts for water availability to ensure efficient irrigation.
        - 🌊 **Flood Analysis**: Understand flood risks in your region with detailed analysis.
        - 📊 **Visualize Water Data**: Season-wise water trends and predictions, all in one place.

        🌾 **Crop Market Analysis:**
        - 💡 **Crop Suggestions**: Receive tailored recommendations based on your land, soil, and season.
        - 📈 **Market Trends**: Analyze current and forecasted prices to determine the best time to sell.

        🦠 **Disease Prediction:**
        - 📷 **Image-Based Diagnosis**: Upload images of your crops to identify diseases and pests.
        - 🌍 **Location-Aware Recommendations**: Get advice tailored to your region's conditions for effective treatment.

        💬 **Chatbot Assistance**:
        - 🗣️ **Instant Farming Advice**: Ask questions and get instant solutions from the AI chatbot.
        - 🖼️ **Image Support**: Upload crop images for more personalized insights.

        👩‍🌾 **Farmer Community**:
        - 🤝 **Connect with Farmers**: Share experiences, tips, and ask questions in the community.
        - 💬 **Group Discussions**: Participate in specific discussions on topics like crop management and market trends.
        """)
